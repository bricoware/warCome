...
function seleccionarArma(){
	...
	var objeto = "arma";
	var xhttp = new XMLHttpRequest();
	var direccion = "modulos/inventario/controlador/actualizar.php?id="+escogida+"&opcion="+objeto;
  		xhttp.open("GET", direccion, true);
  		xhttp.send();
	 xhttp.onreadystatechange = function() {
    	if (this.readyState == 4 && this.status == 200) {
  ...
  function usarPocion(id){
  	...
  	var objeto = "pocion";
  	var xhttp = new XMLHttpRequest();
  	var direccion = "modulos/inventario/controlador/actualizar.php?id="+id+"&opcion="+objeto;
    		xhttp.open("GET", direccion, true);
    		xhttp.send();
  	 xhttp.onreadystatechange = function() {
      	if (this.readyState == 4 && this.status == 200) {
